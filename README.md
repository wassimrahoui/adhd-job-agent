...
4. [`docs/03-job-sources-and-browser-automation.md`](docs/03-job-sources-and-browser-automation.md) — source abstraction, extraction, Playwright automation, and the application-safety flow.
...
13. [`docs/12-architecture-decisions.md`](docs/12-architecture-decisions.md) — ADRs, and where/why this design departs from the two prior prototypes.
...
9. **No automatic applications.** Browser automation may prepare an application; only the user can submit it. Every irreversible action stops, shows the user, and waits.
